...
def test_evaluate(capfd):
	goldText = (
	    'The <disease id="T1">colorectal cancer</disease> was caused by mutations in <gene id="T2">APC</gene>. We also studied <disease id="T3">glioblastoma</disease>.'
	    + '<relation type="typeA" subj="T2" obj="T1" />')
